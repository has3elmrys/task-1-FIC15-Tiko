...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `profile_clinics`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `profile_clinics` (
  ...
  `descriptio` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `doctor_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (6,'2024_03_07_165235_add_phone_role_at_users',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (7,'2024_03_09_040433_create_profile_clinics_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (8,'2024_03_18_064314_create_doctors_table',1);
